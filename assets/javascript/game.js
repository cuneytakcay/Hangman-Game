...
// Declare all variables and an array with a list of scientific words in it.
    ...
    var scienceWords = [
	                    "beaker", "experiment", "einstein", "quantum", "electron", 
	                    "relativity", "neutron", "atom", "distillation", "avagadro",
	                    "molecule", "oxidation", "radioactive", "radiation", "molar"
	                    ];
    var images = [
	              "hangman-01.png", "hangman-02.png", "hangman-03.png", "hangman-04.png", "hangman-05.png", 
